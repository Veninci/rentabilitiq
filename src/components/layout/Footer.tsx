      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              La solution moderne pour calculer et optimiser la rentabilité de vos investissements immobiliers.
            </p>
          </div>

          <div>
            <h4 className="font-medium text-sm tracking-wider uppercase mb-4">Navigation</h4>
            <ul className="space-y-2">
              <li><Link to="/" className="text-muted-foreground hover:text-primary text-sm">Accueil</Link></li>
              <li><Link to="/calculator" className="text-muted-foreground hover:text-primary text-sm">Calculateur</Link></li>
              <li><Link to="/pricing" className="text-muted-foreground hover:text-primary text-sm">Tarifs</Link></li>
              <li><Link to="/about" className="text-muted-foreground hover:text-primary text-sm">À propos</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-medium text-sm tracking-wider uppercase mb-4">Légal</h4>
            <ul className="space-y-2">
              ...
              <li><Link to="/cookies" className="text-muted-foreground hover:text-primary text-sm">Cookies</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} RentabilitiQ. Tous droits réservés.
          </p>
