...
const Footer = () => {
  ...
  // Pages where we want to show the newsletter
  const showNewsletter = location.pathname === '/' || location.pathname === '/pricing';
  ...
  return <footer className="bg-gray-50 border-t border-gray-100 dark:bg-gray-900 dark:border-gray-800">
      <div className="container mx-auto px-4 py-6 md:py-8">
        {/* Newsletter Section - Only show on homepage and pricing page */}
        {showNewsletter && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-2 font-semibold text-lg">
              ...
              <span className="text-slate-950 dark:text-white">RentabilitiQ</span>
            </Link>
          ...
          <div>
            <h4 className="font-medium text-sm tracking-wider uppercase mb-4 text-slate-950 dark:text-white">Navigation Principale</h4>
          ...
          <div>
            <h4 className="font-medium text-sm tracking-wider uppercase mb-4 text-slate-950 dark:text-white">Ressources</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-medium text-sm tracking-wider uppercase mb-4 text-slate-950 dark:text-white">Contact</h4>
