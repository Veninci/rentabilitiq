...
const FormTabs: React.FC<FormTabsProps> = ({ activeTab, onTabChange }) => {
  return (
    <TabsList className="grid grid-cols-4 mb-8 bg-gray-800">
      <TabsTrigger 
        value="purchase" 
        className="text-xs sm:text-sm flex flex-col sm:flex-row items-center gap-1 sm:gap-2 py-2 px-1 sm:px-3 data-[state=active]:bg-primary data-[state=active]:text-white"
      >
