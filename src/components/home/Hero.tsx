...
import { ArrowRight, BarChart4, PieChart, Calculator, Maximize2, Wallet, TrendingUp, Landmark, Settings, X } from 'lucide-react';
    ...
    <section className="relative pt-20 md:pt-32 pb-10 md:pb-24 overflow-hidden px-4 md:px-0">
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto mt-8 md:mt-12 animate-fade-in px-2 sm:px-0" style={{
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm transition-all hover:shadow-md dark:bg-gray-800 dark:border-gray-700">
            <div className="bg-primary/10 h-10 w-10 rounded-lg flex items-center justify-center mb-4">
              <Calculator className="h-5 w-5 text-primary" />
            </div>
            <h3 className="text-lg font-medium mb-2 text-slate-950 dark:text-white">Calcul précis</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm transition-all hover:shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <h3 className="text-lg font-medium mb-2 text-slate-950 dark:text-white">Analyse complète</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm transition-all hover:shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <h3 className="text-lg font-medium mb-2 text-slate-950 dark:text-white">Comparaison visuelle</h3>
        ...
        <DialogContent className="sm:max-w-[90vw] md:max-w-[80vw] lg:max-w-[75vw] p-0 bg-transparent border-none shadow-none max-h-[90vh] overflow-y-auto">
          <div className="relative">
            ...
            <GlassCard variant="elevated" className="w-full overflow-hidden p-2 sm:p-3 md:p-4 lg:p-6">
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl overflow-hidden dark:from-gray-900 dark:to-gray-800">
                <div className="p-3 sm:p-4 md:p-6 lg:p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
                    <div className="col-span-1 md:col-span-2 bg-white rounded-xl shadow-md p-3 sm:p-4 md:p-5 lg:p-6 dark:bg-gray-800">
                      <div className="flex items-center justify-between mb-3 sm:mb-4 md:mb-5 lg:mb-6">
                        ...
                        <div className="flex space-x-1 sm:space-x-2 md:space-x-3">
                          ...
                          <div className="px-1.5 sm:px-2 md:px-2.5 lg:px-3.5 py-0.5 sm:py-1 md:py-1 lg:py-1.5 bg-gray-100 rounded text-[10px] sm:text-xs md:text-sm lg:text-base text-gray-500 font-medium dark:bg-gray-700 dark:text-gray-300">Lyon</div>
                        </div>
                      </div>
                      
                      <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 lg:gap-6 mb-3 sm:mb-4 md:mb-5 lg:mb-6">
                        <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                          <div className="text-xs md:text-sm lg:text-base text-gray-500 dark:text-gray-300">Prix d'achat</div>
                        ...
                        <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                          <div className="text-xs md:text-sm lg:text-base text-gray-500 dark:text-gray-300">Surface</div>
                        ...
                        <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                          <div className="text-xs md:text-sm lg:text-base text-gray-500 dark:text-gray-300">Loyer mensuel</div>
                        ...
                        <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                          <div className="text-xs md:text-sm lg:text-base text-gray-500 dark:text-gray-300">Type de location</div>
                        ...
                        <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                          <div className="text-xs md:text-sm lg:text-base text-gray-500 dark:text-gray-300">Apport</div>
                        ...
                        <div className="space-y-1 sm:space-y-1.5 md:space-y-2">
                          <div className="text-xs md:text-sm lg:text-base text-gray-500 dark:text-gray-300">Taux d'intérêt</div>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-3 sm:p-4 md:p-5 lg:p-6 flex flex-col dark:bg-gray-800">
                      <div className="flex items-center justify-between mb-3 sm:mb-4 md:mb-5 lg:mb-6">
                      ...
                      <div className="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-6 flex-grow">
                        <div className="flex items-center justify-between bg-gray-50 p-2 sm:p-3 md:p-4 rounded-lg dark:bg-gray-700">
                          <div className="flex items-center">
                            <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 text-primary mr-1.5 sm:mr-2 md:mr-3" />
                            <div className="text-xs md:text-sm lg:text-base text-muted-foreground dark:text-gray-300">Rendement brut</div>
                          </div>
                        ...
                        <div className="flex items-center justify-between bg-gray-50 p-2 sm:p-3 md:p-4 rounded-lg dark:bg-gray-700">
                          <div className="flex items-center">
                            ...
                            <div className="text-xs md:text-sm lg:text-base text-muted-foreground dark:text-gray-300">Cash-flow mensuel</div>
                          </div>
                        ...
                        <div className="flex items-center justify-between bg-gray-50 p-2 sm:p-3 md:p-4 rounded-lg dark:bg-gray-700">
                          <div className="flex items-center">
                            ...
                            <div className="text-xs md:text-sm lg:text-base text-muted-foreground dark:text-gray-300">Mensualité crédit</div>
                          </div>
                          <div className="font-medium text-blue-500 text-sm sm:text-base md:text-lg">614 €</div>
                        </div>
                      </div>
                      
                      <div className="mt-3 sm:mt-4 md:mt-5 lg:mt-6 h-24 sm:h-28 md:h-32 lg:h-40 bg-gray-50 rounded-lg flex items-center justify-center relative dark:bg-gray-700">
                        <PieChart className="h-12 w-12 sm:h-16 sm:w-16 md:h-20 md:w-20 lg:h-24 lg:w-24 text-primary/30 absolute" />
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="bg-white rounded-full h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 lg:h-28 lg:w-28 flex items-center justify-center shadow-md dark:bg-gray-800">
                            <div className="text-center">
                              <div className="text-xl sm:text-2xl md:text-2xl lg:text-3xl font-bold text-primary">4.2%</div>
                              <div className="text-xs sm:text-xs md:text-sm text-gray-500 dark:text-gray-300">Rendement</div>
                            </div>
                          </div>
                        </div>
                      </div>
